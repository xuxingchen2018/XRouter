...
/**
 * support fragment launcher
 */
public class FragmentSupportLauncher extends BaseLauncher {

    private Fragment mFragment;

    public FragmentSupportLauncher(Fragment fragment, Intent intent, int requestCode) {
        super(intent, requestCode);
        mFragment = fragment;
    }

    public FragmentSupportLauncher intercept(IntentInterceptor interceptor) {
